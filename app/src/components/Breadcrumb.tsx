...
export const breadcrumbLinkStyle = cva("text-sm font-medium text-gray-700 hover:text-blue-600 ml-2");
...
export const BreadcrumbCurrentPageWithIcon = ({ children }: PropsWithChildren) => {
  return (
    <li className="inline-flex items-center" aria-current="page">
      <BreadcrumbSeparator />
      <span className="ml-2 text-sm font-medium text-gray-500 inline-flex items-center">{children}</span>
    </li>
  );
};
